...
class AuditivaMapBuilder implements MapBuilder {

	
	const CLASS_NAME = 'lib.model.map.AuditivaMapBuilder';
	...
	{
		$this->dbMap = Propel::getDatabaseMap(AuditivaPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(AuditivaPeer::TABLE_NAME);
		$tMap->setPhpName('Auditiva');
		$tMap->setClassname('Auditiva');
