...
class VisualMapBuilder implements MapBuilder {

	
	const CLASS_NAME = 'lib.model.map.VisualMapBuilder';
	...
	{
		$this->dbMap = Propel::getDatabaseMap(VisualPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(VisualPeer::TABLE_NAME);
		$tMap->setPhpName('Visual');
		$tMap->setClassname('Visual');
