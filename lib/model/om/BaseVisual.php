...
abstract class BaseVisual extends BaseObject  implements Persistent {


  const PEER = 'VisualPeer';
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = VisualPeer::ID;
		}
	...
	public function setFkEstablecimientoId($v)
	{
		...
		if ($this->fk_establecimiento_id !== $v || $v === 0) {
			...
			$this->modifiedColumns[] = VisualPeer::FK_ESTABLECIMIENTO_ID;
		}
	...
	public function setFkCarreraId($v)
	{
		...
		if ($this->fk_carrera_id !== $v || $v === 0) {
			...
			$this->modifiedColumns[] = VisualPeer::FK_CARRERA_ID;
		}
	...
	public function setNombre($v)
	{
		...
		if ($this->nombre !== $v) {
			$this->nombre = $v;
			$this->modifiedColumns[] = VisualPeer::NOMBRE;
		}
	...
	public function setDescripcion($v)
	{
		...
		if ($this->descripcion !== $v) {
			$this->descripcion = $v;
			$this->modifiedColumns[] = VisualPeer::DESCRIPCION;
		}
	...
	public function setOrden($v)
	{
		...
		if ($this->orden !== $v) {
			$this->orden = $v;
			$this->modifiedColumns[] = VisualPeer::ORDEN;
		}
	...
	public function setAnio($v)
	{
		...
		if ($this->anio !== $v) {
			$this->anio = $v;
			$this->modifiedColumns[] = VisualPeer::ANIO;
		}
	...
	{
						if (array_diff($this->modifiedColumns, array(VisualPeer::FK_ESTABLECIMIENTO_ID,VisualPeer::FK_CARRERA_ID))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			throw new PropelException("Error populating Visual object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = VisualPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			VisualPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
		...
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			...
			if ($this->isNew() ) {
				$this->modifiedColumns[] = VisualPeer::ID;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = VisualPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += VisualPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = VisualPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = VisualPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = VisualPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(VisualPeer::ID)) $criteria->add(VisualPeer::ID, $this->id);
		if ($this->isColumnModified(VisualPeer::FK_ESTABLECIMIENTO_ID)) $criteria->add(VisualPeer::FK_ESTABLECIMIENTO_ID, $this->fk_establecimiento_id);
		if ($this->isColumnModified(VisualPeer::FK_CARRERA_ID)) $criteria->add(VisualPeer::FK_CARRERA_ID, $this->fk_carrera_id);
		if ($this->isColumnModified(VisualPeer::NOMBRE)) $criteria->add(VisualPeer::NOMBRE, $this->nombre);
		if ($this->isColumnModified(VisualPeer::DESCRIPCION)) $criteria->add(VisualPeer::DESCRIPCION, $this->descripcion);
		if ($this->isColumnModified(VisualPeer::ORDEN)) $criteria->add(VisualPeer::ORDEN, $this->orden);
		if ($this->isColumnModified(VisualPeer::ANIO)) $criteria->add(VisualPeer::ANIO, $this->anio);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(VisualPeer::ID, $this->id);
