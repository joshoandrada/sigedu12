...
abstract class BaseEstablecimiento extends BaseObject  implements Persistent {
  ...
  const PEER = 'EstablecimientoPeer';
	...
	public function getUsuariosJoinAlumno($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(EstablecimientoPeer::DATABASE_NAME);
		}
		...
		if ($this->collUsuarios === null) {
			if ($this->isNew()) {
				...
				$this->collUsuarios = UsuarioPeer::doSelectJoinAlumno($criteria, $con, $join_behavior);
			}
		} else {
	...
	public function getAlumnosJoinCarrera($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(EstablecimientoPeer::DATABASE_NAME);
		}
		...
		if ($this->collAlumnos === null) {
			if ($this->isNew()) {
				...
				$this->collAlumnos = AlumnoPeer::doSelectJoinCarrera($criteria, $con, $join_behavior);
			}
		} else {
		...
		if ($this->collNeuros === null) {
			if ($this->isNew()) {
			   $this->collNeuros = array();
				...
				$criteria->add(NeuroPeer::FK_ESTABLECIMIENTO_ID, $this->id);
	...
	public function getNeurosJoinCarrera($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(EstablecimientoPeer::DATABASE_NAME);
		}
		...
		if ($this->collNeuros === null) {
			if ($this->isNew()) {
				...
				$this->collNeuros = NeuroPeer::doSelectJoinCarrera($criteria, $con, $join_behavior);
			}
		} else {
		...
		if ($this->collComuns === null) {
			if ($this->isNew()) {
			   $this->collComuns = array();
				...
				$criteria->add(ComunPeer::FK_ESTABLECIMIENTO_ID, $this->id);
	...
	public function getComunsJoinCarrera($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(EstablecimientoPeer::DATABASE_NAME);
		}
		...
		if ($this->collComuns === null) {
			if ($this->isNew()) {
				...
				$this->collComuns = ComunPeer::doSelectJoinCarrera($criteria, $con, $join_behavior);
			}
		} else {
		...
		if ($this->collVisuals === null) {
			if ($this->isNew()) {
			   $this->collVisuals = array();
				...
				$criteria->add(VisualPeer::FK_ESTABLECIMIENTO_ID, $this->id);
	...
	public function getVisualsJoinCarrera($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(EstablecimientoPeer::DATABASE_NAME);
		}
		...
		if ($this->collVisuals === null) {
			if ($this->isNew()) {
				...
				$this->collVisuals = VisualPeer::doSelectJoinCarrera($criteria, $con, $join_behavior);
			}
		} else {
		...
		if ($this->collAuditivas === null) {
			if ($this->isNew()) {
			   $this->collAuditivas = array();
				...
				$criteria->add(AuditivaPeer::FK_ESTABLECIMIENTO_ID, $this->id);
	...
	public function getAuditivasJoinCarrera($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(EstablecimientoPeer::DATABASE_NAME);
		}
		...
		if ($this->collAuditivas === null) {
			if ($this->isNew()) {
				...
				$this->collAuditivas = AuditivaPeer::doSelectJoinCarrera($criteria, $con, $join_behavior);
			}
		} else {
		...
		if ($this->collIntelectuals === null) {
			if ($this->isNew()) {
			   $this->collIntelectuals = array();
				...
				$criteria->add(IntelectualPeer::FK_ESTABLECIMIENTO_ID, $this->id);
	...
	public function getIntelectualsJoinCarrera($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(EstablecimientoPeer::DATABASE_NAME);
		}
		...
		if ($this->collIntelectuals === null) {
			if ($this->isNew()) {
				...
				$this->collIntelectuals = IntelectualPeer::doSelectJoinCarrera($criteria, $con, $join_behavior);
			}
		} else {
