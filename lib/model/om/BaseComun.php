...
abstract class BaseComun extends BaseObject  implements Persistent {


  const PEER = 'ComunPeer';
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ComunPeer::ID;
		}
	...
	public function setFkEstablecimientoId($v)
	{
		...
		if ($this->fk_establecimiento_id !== $v || $v === 0) {
			...
			$this->modifiedColumns[] = ComunPeer::FK_ESTABLECIMIENTO_ID;
		}
	...
	public function setFkCarreraId($v)
	{
		...
		if ($this->fk_carrera_id !== $v || $v === 0) {
			...
			$this->modifiedColumns[] = ComunPeer::FK_CARRERA_ID;
		}
	...
	public function setNombre($v)
	{
		...
		if ($this->nombre !== $v) {
			$this->nombre = $v;
			$this->modifiedColumns[] = ComunPeer::NOMBRE;
		}
	...
	public function setDescripcion($v)
	{
		...
		if ($this->descripcion !== $v) {
			$this->descripcion = $v;
			$this->modifiedColumns[] = ComunPeer::DESCRIPCION;
		}
	...
	public function setOrden($v)
	{
		...
		if ($this->orden !== $v) {
			$this->orden = $v;
			$this->modifiedColumns[] = ComunPeer::ORDEN;
		}
	...
	public function setAnio($v)
	{
		...
		if ($this->anio !== $v) {
			$this->anio = $v;
			$this->modifiedColumns[] = ComunPeer::ANIO;
		}
	...
	{
						if (array_diff($this->modifiedColumns, array(ComunPeer::FK_ESTABLECIMIENTO_ID,ComunPeer::FK_CARRERA_ID))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			throw new PropelException("Error populating Comun object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ComunPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			ComunPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
		...
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			...
			if ($this->isNew() ) {
				$this->modifiedColumns[] = ComunPeer::ID;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ComunPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += ComunPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ComunPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ComunPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ComunPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ComunPeer::ID)) $criteria->add(ComunPeer::ID, $this->id);
		if ($this->isColumnModified(ComunPeer::FK_ESTABLECIMIENTO_ID)) $criteria->add(ComunPeer::FK_ESTABLECIMIENTO_ID, $this->fk_establecimiento_id);
		if ($this->isColumnModified(ComunPeer::FK_CARRERA_ID)) $criteria->add(ComunPeer::FK_CARRERA_ID, $this->fk_carrera_id);
		if ($this->isColumnModified(ComunPeer::NOMBRE)) $criteria->add(ComunPeer::NOMBRE, $this->nombre);
		if ($this->isColumnModified(ComunPeer::DESCRIPCION)) $criteria->add(ComunPeer::DESCRIPCION, $this->descripcion);
		if ($this->isColumnModified(ComunPeer::ORDEN)) $criteria->add(ComunPeer::ORDEN, $this->orden);
		if ($this->isColumnModified(ComunPeer::ANIO)) $criteria->add(ComunPeer::ANIO, $this->anio);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ComunPeer::ID, $this->id);
