...
abstract class BaseRelDivisionActividadDocentePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'FkDivisionId', 'FkActividadId', 'FkDocenteId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'fkDivisionId', 'fkActividadId', 'fkDocenteId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::FK_DIVISION_ID, self::FK_ACTIVIDAD_ID, self::FK_DOCENTE_ID, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'fk_division_id', 'fk_actividad_id', 'fk_docente_id', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'FkDivisionId' => 1, 'FkActividadId' => 2, 'FkDocenteId' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'fkDivisionId' => 1, 'fkActividadId' => 2, 'fkDocenteId' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::FK_DIVISION_ID => 1, self::FK_ACTIVIDAD_ID => 2, self::FK_DOCENTE_ID => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'fk_division_id' => 1, 'fk_actividad_id' => 2, 'fk_docente_id' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
