...
abstract class BaseIntelectual extends BaseObject  implements Persistent {


  const PEER = 'IntelectualPeer';
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = IntelectualPeer::ID;
		}
	...
	public function setFkEstablecimientoId($v)
	{
		...
		if ($this->fk_establecimiento_id !== $v || $v === 0) {
			...
			$this->modifiedColumns[] = IntelectualPeer::FK_ESTABLECIMIENTO_ID;
		}
	...
	public function setFkCarreraId($v)
	{
		...
		if ($this->fk_carrera_id !== $v || $v === 0) {
			...
			$this->modifiedColumns[] = IntelectualPeer::FK_CARRERA_ID;
		}
	...
	public function setNombre($v)
	{
		...
		if ($this->nombre !== $v) {
			$this->nombre = $v;
			$this->modifiedColumns[] = IntelectualPeer::NOMBRE;
		}
	...
	public function setDescripcion($v)
	{
		...
		if ($this->descripcion !== $v) {
			$this->descripcion = $v;
			$this->modifiedColumns[] = IntelectualPeer::DESCRIPCION;
		}
	...
	public function setOrden($v)
	{
		...
		if ($this->orden !== $v) {
			$this->orden = $v;
			$this->modifiedColumns[] = IntelectualPeer::ORDEN;
		}
	...
	public function setAnio($v)
	{
		...
		if ($this->anio !== $v) {
			$this->anio = $v;
			$this->modifiedColumns[] = IntelectualPeer::ANIO;
		}
	...
	{
						if (array_diff($this->modifiedColumns, array(IntelectualPeer::FK_ESTABLECIMIENTO_ID,IntelectualPeer::FK_CARRERA_ID))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			throw new PropelException("Error populating Intelectual object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = IntelectualPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			IntelectualPeer::doDelete($this, $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			IntelectualPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
		...
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			...
			if ($this->isNew() ) {
				$this->modifiedColumns[] = IntelectualPeer::ID;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = IntelectualPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += IntelectualPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = IntelectualPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = IntelectualPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = IntelectualPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(IntelectualPeer::ID)) $criteria->add(IntelectualPeer::ID, $this->id);
		if ($this->isColumnModified(IntelectualPeer::FK_ESTABLECIMIENTO_ID)) $criteria->add(IntelectualPeer::FK_ESTABLECIMIENTO_ID, $this->fk_establecimiento_id);
		if ($this->isColumnModified(IntelectualPeer::FK_CARRERA_ID)) $criteria->add(IntelectualPeer::FK_CARRERA_ID, $this->fk_carrera_id);
		if ($this->isColumnModified(IntelectualPeer::NOMBRE)) $criteria->add(IntelectualPeer::NOMBRE, $this->nombre);
		if ($this->isColumnModified(IntelectualPeer::DESCRIPCION)) $criteria->add(IntelectualPeer::DESCRIPCION, $this->descripcion);
		if ($this->isColumnModified(IntelectualPeer::ORDEN)) $criteria->add(IntelectualPeer::ORDEN, $this->orden);
		if ($this->isColumnModified(IntelectualPeer::ANIO)) $criteria->add(IntelectualPeer::ANIO, $this->anio);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(IntelectualPeer::ID, $this->id);
