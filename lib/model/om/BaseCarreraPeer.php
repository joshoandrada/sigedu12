...
abstract class BaseCarreraPeer {
	...
	const FK_ESTABLECIMIENTO_ID = 'carrera.FK_ESTABLECIMIENTO_ID';

	
	const DESCRIPCION = 'carrera.DESCRIPCION';

	
	const ABREV = 'carrera.ABREV';

	
	const ANIO = 'carrera.ANIO';

	
	const ORDEN = 'carrera.ORDEN';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'FkEstablecimientoId', 'Descripcion', 'Abrev', 'Anio', 'Orden', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'fkEstablecimientoId', 'descripcion', 'abrev', 'anio', 'orden', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::FK_ESTABLECIMIENTO_ID, self::DESCRIPCION, self::ABREV, self::ANIO, self::ORDEN, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'fk_establecimiento_id', 'descripcion', 'abrev', 'anio', 'orden', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'FkEstablecimientoId' => 1, 'Descripcion' => 2, 'Abrev' => 3, 'Anio' => 4, 'Orden' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'fkEstablecimientoId' => 1, 'descripcion' => 2, 'abrev' => 3, 'anio' => 4, 'orden' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::FK_ESTABLECIMIENTO_ID => 1, self::DESCRIPCION => 2, self::ABREV => 3, self::ANIO => 4, self::ORDEN => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'fk_establecimiento_id' => 1, 'descripcion' => 2, 'abrev' => 3, 'anio' => 4, 'orden' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new CarreraMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CarreraPeer::FK_ESTABLECIMIENTO_ID);

		$criteria->addSelectColumn(CarreraPeer::DESCRIPCION);

		$criteria->addSelectColumn(CarreraPeer::ABREV);

		$criteria->addSelectColumn(CarreraPeer::ANIO);

		$criteria->addSelectColumn(CarreraPeer::ORDEN);
	...
	public static function doCountJoinEstablecimiento(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(CarreraPeer::FK_ESTABLECIMIENTO_ID,), array(EstablecimientoPeer::ID,), $join_behavior);
	...
	public static function doSelectJoinEstablecimiento(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$startcol = (CarreraPeer::NUM_COLUMNS - CarreraPeer::NUM_LAZY_LOAD_COLUMNS);
		EstablecimientoPeer::addSelectColumns($c);

		$c->addJoin(array(CarreraPeer::FK_ESTABLECIMIENTO_ID,), array(EstablecimientoPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();

		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = CarreraPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj1 = CarreraPeer::getInstanceFromPool($key1))) {
															} else {
				...
				$obj1 = new $cls();
				$obj1->hydrate($row);
				CarreraPeer::addInstanceToPool($obj1, $key1);
			} 
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		CarreraPeer::addSelectColumns($c);
		$startcol2 = (CarreraPeer::NUM_COLUMNS - CarreraPeer::NUM_LAZY_LOAD_COLUMNS);
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(CarreraPeer::ID) && $criteria->keyContainsValue(CarreraPeer::ID) ) {
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
						...
						$criteria = clone $values;
		} elseif ($values instanceof Carrera) {
...
Propel::getDatabaseMap(BaseCarreraPeer::DATABASE_NAME)->addTableBuilder(BaseCarreraPeer::TABLE_NAME, BaseCarreraPeer::getMapBuilder());
