...
abstract class BaseDocente extends BaseObject  implements Persistent {
  ...
  const PEER = 'DocentePeer';
	...
	protected $collActividadsRelatedByPresidente;

	
	private $lastActividadRelatedByPresidenteCriteria = null;

	
	protected $collActividadsRelatedByVocal1;

	
	private $lastActividadRelatedByVocal1Criteria = null;

	
	protected $collActividadsRelatedByVocal2;

	
	private $lastActividadRelatedByVocal2Criteria = null;
	...
	public function setFechaIngreso($v)
	{
		...
		if ( $this->fecha_ingreso !== null || $dt !== null ) {
			...
			$currNorm = ($this->fecha_ingreso !== null && $tmpDt = new DateTime($this->fecha_ingreso)) ? $tmpDt->format('Y-m-d H:i:s') : null;
			$newNorm = ($dt !== null) ? $dt->format('Y-m-d H:i:s') : null;

			if ( ($currNorm !== $newNorm) 					)
			{
				$this->fecha_ingreso = ($dt ? $dt->format('Y-m-d H:i:s') : null);
				$this->modifiedColumns[] = DocentePeer::FECHA_INGRESO;
			}
		} 
		return $this;
	} 
	...
	public function setCuil($v)
	{
		...
		if ($this->cuil !== $v) {
			$this->cuil = $v;
			$this->modifiedColumns[] = DocentePeer::CUIL;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->fk_tipodocumento_id = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
			$this->nro_documento = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
			$this->cuil = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			...
			$this->ciudad = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
			$this->codigo_postal = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
			$this->email = ($row[$startcol + 15] !== null) ? (string) $row[$startcol + 15] : null;
			$this->telefono = ($row[$startcol + 16] !== null) ? (string) $row[$startcol + 16] : null;
			$this->telefono_movil = ($row[$startcol + 17] !== null) ? (string) $row[$startcol + 17] : null;
			$this->titulo = ($row[$startcol + 18] !== null) ? (string) $row[$startcol + 18] : null;
			$this->libreta_sanitaria = ($row[$startcol + 19] !== null) ? (boolean) $row[$startcol + 19] : null;
			$this->psicofisico = ($row[$startcol + 20] !== null) ? (boolean) $row[$startcol + 20] : null;
			$this->observacion = ($row[$startcol + 21] !== null) ? (string) $row[$startcol + 21] : null;
			$this->activo = ($row[$startcol + 22] !== null) ? (boolean) $row[$startcol + 22] : null;
			$this->fk_provincia_id = ($row[$startcol + 23] !== null) ? (int) $row[$startcol + 23] : null;
			$this->fk_pais_id = ($row[$startcol + 24] !== null) ? (int) $row[$startcol + 24] : null;
			$this->resetModified();
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  
			...
			$this->aProvincia = null;
			$this->aPais = null;
			$this->collActividadsRelatedByPresidente = null;
			$this->lastActividadRelatedByPresidenteCriteria = null;

			$this->collActividadsRelatedByVocal1 = null;
			$this->lastActividadRelatedByVocal1Criteria = null;

			$this->collActividadsRelatedByVocal2 = null;
			$this->lastActividadRelatedByVocal2Criteria = null;
	...
	protected function doSave(PropelPDO $con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			...
			if ($this->collActividadsRelatedByPresidente !== null) {
				foreach ($this->collActividadsRelatedByPresidente as $referrerFK) {
			...
			if ($this->collActividadsRelatedByVocal1 !== null) {
				foreach ($this->collActividadsRelatedByVocal1 as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
			...
			if ($this->collActividadsRelatedByVocal2 !== null) {
				foreach ($this->collActividadsRelatedByVocal2 as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[8] => $this->getFkTipodocumentoId(),
			$keys[9] => $this->getNroDocumento(),
			$keys[10] => $this->getCuil(),
			$keys[11] => $this->getLugarNacimiento(),
			$keys[12] => $this->getDireccion(),
			$keys[13] => $this->getCiudad(),
			$keys[14] => $this->getCodigoPostal(),
			$keys[15] => $this->getEmail(),
			$keys[16] => $this->getTelefono(),
			$keys[17] => $this->getTelefonoMovil(),
			$keys[18] => $this->getTitulo(),
			$keys[19] => $this->getLibretaSanitaria(),
			$keys[20] => $this->getPsicofisico(),
			$keys[21] => $this->getObservacion(),
			$keys[22] => $this->getActivo(),
			$keys[23] => $this->getFkProvinciaId(),
			$keys[24] => $this->getFkPaisId(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[8], $arr)) $this->setFkTipodocumentoId($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setNroDocumento($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setCuil($arr[$keys[10]]);
		...
		if (array_key_exists($keys[13], $arr)) $this->setCiudad($arr[$keys[13]]);
		if (array_key_exists($keys[14], $arr)) $this->setCodigoPostal($arr[$keys[14]]);
		if (array_key_exists($keys[15], $arr)) $this->setEmail($arr[$keys[15]]);
		if (array_key_exists($keys[16], $arr)) $this->setTelefono($arr[$keys[16]]);
		if (array_key_exists($keys[17], $arr)) $this->setTelefonoMovil($arr[$keys[17]]);
		if (array_key_exists($keys[18], $arr)) $this->setTitulo($arr[$keys[18]]);
		if (array_key_exists($keys[19], $arr)) $this->setLibretaSanitaria($arr[$keys[19]]);
		if (array_key_exists($keys[20], $arr)) $this->setPsicofisico($arr[$keys[20]]);
		if (array_key_exists($keys[21], $arr)) $this->setObservacion($arr[$keys[21]]);
		if (array_key_exists($keys[22], $arr)) $this->setActivo($arr[$keys[22]]);
		if (array_key_exists($keys[23], $arr)) $this->setFkProvinciaId($arr[$keys[23]]);
		if (array_key_exists($keys[24], $arr)) $this->setFkPaisId($arr[$keys[24]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(DocentePeer::FECHA_INGRESO)) $criteria->add(DocentePeer::FECHA_INGRESO, $this->fecha_ingreso);
		...
		if ($this->isColumnModified(DocentePeer::CUIL)) $criteria->add(DocentePeer::CUIL, $this->cuil);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		if ($deepCopy) {
			...
			foreach ($this->getActividadsRelatedByPresidente() as $relObj) {
				if ($relObj !== $this) {  					$copyObj->addActividadRelatedByPresidente($relObj->copy($deepCopy));
				}
			}

			foreach ($this->getActividadsRelatedByVocal1() as $relObj) {
				if ($relObj !== $this) {  					$copyObj->addActividadRelatedByVocal1($relObj->copy($deepCopy));
				}
			}

			foreach ($this->getActividadsRelatedByVocal2() as $relObj) {
				if ($relObj !== $this) {  					$copyObj->addActividadRelatedByVocal2($relObj->copy($deepCopy));
				}
			}
	...
	public function clearActividadsRelatedByPresidente()
	{
		$this->collActividadsRelatedByPresidente = null; 	}

	
	public function initActividadsRelatedByPresidente()
	{
		$this->collActividadsRelatedByPresidente = array();
	}

	
	public function getActividadsRelatedByPresidente($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(DocentePeer::DATABASE_NAME);
		}
		...
		if ($this->collActividadsRelatedByPresidente === null) {
			if ($this->isNew()) {
			   $this->collActividadsRelatedByPresidente = array();
				...
				$criteria->add(ActividadPeer::PRESIDENTE, $this->id);

				ActividadPeer::addSelectColumns($criteria);
				$this->collActividadsRelatedByPresidente = ActividadPeer::doSelect($criteria, $con);
			}
		} else {
						if (!$this->isNew()) {
				...
				ActividadPeer::addSelectColumns($criteria);
				if (!isset($this->lastActividadRelatedByPresidenteCriteria) || !$this->lastActividadRelatedByPresidenteCriteria->equals($criteria)) {
					$this->collActividadsRelatedByPresidente = ActividadPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastActividadRelatedByPresidenteCriteria = $criteria;
		return $this->collActividadsRelatedByPresidente;
	}

	
	public function countActividadsRelatedByPresidente(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(DocentePeer::DATABASE_NAME);
		} else {
		...
		if ($this->collActividadsRelatedByPresidente === null) {
			if ($this->isNew()) {
				...
				if (!isset($this->lastActividadRelatedByPresidenteCriteria) || !$this->lastActividadRelatedByPresidenteCriteria->equals($criteria)) {
					...
					$count = count($this->collActividadsRelatedByPresidente);
				}
			} else {
				$count = count($this->collActividadsRelatedByPresidente);
			}
	...
	public function addActividadRelatedByPresidente(Actividad $l)
	{
		if ($this->collActividadsRelatedByPresidente === null) {
			$this->initActividadsRelatedByPresidente();
		}
		if (!in_array($l, $this->collActividadsRelatedByPresidente, true)) { 			array_push($this->collActividadsRelatedByPresidente, $l);
			$l->setDocenteRelatedByPresidente($this);
		}
	}


	
	public function getActividadsRelatedByPresidenteJoinEstablecimiento($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(DocentePeer::DATABASE_NAME);
		}
		...
		if ($this->collActividadsRelatedByPresidente === null) {
			if ($this->isNew()) {
				...
				$this->collActividadsRelatedByPresidente = ActividadPeer::doSelectJoinEstablecimiento($criteria, $con, $join_behavior);
			}
		} else {
	...
	public function getActividadsRelatedByPresidenteJoinCarrera($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(DocentePeer::DATABASE_NAME);
		}
		...
		if ($this->collActividadsRelatedByPresidente === null) {
			if ($this->isNew()) {
				...
				$this->collActividadsRelatedByPresidente = ActividadPeer::doSelectJoinCarrera($criteria, $con, $join_behavior);
			}
		} else {
	...
	public function getActividadsRelatedByPresidenteJoinLlamados($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(DocentePeer::DATABASE_NAME);
		}
		...
		if ($this->collActividadsRelatedByPresidente === null) {
			if ($this->isNew()) {
				...
				$this->collActividadsRelatedByPresidente = ActividadPeer::doSelectJoinLlamados($criteria, $con, $join_behavior);
			}
		} else {
	...
	public function clearActividadsRelatedByVocal1()
	{
		$this->collActividadsRelatedByVocal1 = null; 	}

	
	public function initActividadsRelatedByVocal1()
	{
		$this->collActividadsRelatedByVocal1 = array();
	}

	
	public function getActividadsRelatedByVocal1($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(DocentePeer::DATABASE_NAME);
		}
		...
		if ($this->collActividadsRelatedByVocal1 === null) {
			if ($this->isNew()) {
			   $this->collActividadsRelatedByVocal1 = array();
				...
				$criteria->add(ActividadPeer::VOCAL1, $this->id);

				ActividadPeer::addSelectColumns($criteria);
				$this->collActividadsRelatedByVocal1 = ActividadPeer::doSelect($criteria, $con);
			}
		} else {
						if (!$this->isNew()) {
				...
				ActividadPeer::addSelectColumns($criteria);
				if (!isset($this->lastActividadRelatedByVocal1Criteria) || !$this->lastActividadRelatedByVocal1Criteria->equals($criteria)) {
					$this->collActividadsRelatedByVocal1 = ActividadPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastActividadRelatedByVocal1Criteria = $criteria;
		return $this->collActividadsRelatedByVocal1;
	}

	
	public function countActividadsRelatedByVocal1(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(DocentePeer::DATABASE_NAME);
		} else {
		...
		if ($this->collActividadsRelatedByVocal1 === null) {
			if ($this->isNew()) {
				...
				if (!isset($this->lastActividadRelatedByVocal1Criteria) || !$this->lastActividadRelatedByVocal1Criteria->equals($criteria)) {
					...
					$count = count($this->collActividadsRelatedByVocal1);
				}
			} else {
				$count = count($this->collActividadsRelatedByVocal1);
			}
	...
	public function addActividadRelatedByVocal1(Actividad $l)
	{
		if ($this->collActividadsRelatedByVocal1 === null) {
			$this->initActividadsRelatedByVocal1();
		}
		if (!in_array($l, $this->collActividadsRelatedByVocal1, true)) { 			array_push($this->collActividadsRelatedByVocal1, $l);
			$l->setDocenteRelatedByVocal1($this);
		}
	}


	
	public function getActividadsRelatedByVocal1JoinEstablecimiento($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(DocentePeer::DATABASE_NAME);
		}
		...
		if ($this->collActividadsRelatedByVocal1 === null) {
			if ($this->isNew()) {
				...
				$this->collActividadsRelatedByVocal1 = ActividadPeer::doSelectJoinEstablecimiento($criteria, $con, $join_behavior);
			}
		} else {
	...
	public function getActividadsRelatedByVocal1JoinCarrera($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(DocentePeer::DATABASE_NAME);
		}
		...
		if ($this->collActividadsRelatedByVocal1 === null) {
			if ($this->isNew()) {
				...
				$this->collActividadsRelatedByVocal1 = ActividadPeer::doSelectJoinCarrera($criteria, $con, $join_behavior);
			}
		} else {
	...
	public function getActividadsRelatedByVocal1JoinLlamados($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(DocentePeer::DATABASE_NAME);
		}
		...
		if ($this->collActividadsRelatedByVocal1 === null) {
			if ($this->isNew()) {
				...
				$this->collActividadsRelatedByVocal1 = ActividadPeer::doSelectJoinLlamados($criteria, $con, $join_behavior);
			}
		} else {
	...
	public function clearActividadsRelatedByVocal2()
	{
		$this->collActividadsRelatedByVocal2 = null; 	}

	
	public function initActividadsRelatedByVocal2()
	{
		$this->collActividadsRelatedByVocal2 = array();
	}

	
	public function getActividadsRelatedByVocal2($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(DocentePeer::DATABASE_NAME);
		}
		...
		if ($this->collActividadsRelatedByVocal2 === null) {
			if ($this->isNew()) {
			   $this->collActividadsRelatedByVocal2 = array();
				...
				$criteria->add(ActividadPeer::VOCAL2, $this->id);

				ActividadPeer::addSelectColumns($criteria);
				$this->collActividadsRelatedByVocal2 = ActividadPeer::doSelect($criteria, $con);
			}
		} else {
						if (!$this->isNew()) {
				...
				ActividadPeer::addSelectColumns($criteria);
				if (!isset($this->lastActividadRelatedByVocal2Criteria) || !$this->lastActividadRelatedByVocal2Criteria->equals($criteria)) {
					$this->collActividadsRelatedByVocal2 = ActividadPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastActividadRelatedByVocal2Criteria = $criteria;
		return $this->collActividadsRelatedByVocal2;
	}

	
	public function countActividadsRelatedByVocal2(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(DocentePeer::DATABASE_NAME);
		} else {
		...
		if ($this->collActividadsRelatedByVocal2 === null) {
			if ($this->isNew()) {
				...
				if (!isset($this->lastActividadRelatedByVocal2Criteria) || !$this->lastActividadRelatedByVocal2Criteria->equals($criteria)) {
					...
					$count = count($this->collActividadsRelatedByVocal2);
				}
			} else {
				$count = count($this->collActividadsRelatedByVocal2);
			}
	...
	public function addActividadRelatedByVocal2(Actividad $l)
	{
		if ($this->collActividadsRelatedByVocal2 === null) {
			$this->initActividadsRelatedByVocal2();
		}
		if (!in_array($l, $this->collActividadsRelatedByVocal2, true)) { 			array_push($this->collActividadsRelatedByVocal2, $l);
			$l->setDocenteRelatedByVocal2($this);
		}
	}


	
	public function getActividadsRelatedByVocal2JoinEstablecimiento($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(DocentePeer::DATABASE_NAME);
		}
		...
		if ($this->collActividadsRelatedByVocal2 === null) {
			if ($this->isNew()) {
				...
				$this->collActividadsRelatedByVocal2 = ActividadPeer::doSelectJoinEstablecimiento($criteria, $con, $join_behavior);
			}
		} else {
	...
	public function getActividadsRelatedByVocal2JoinCarrera($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(DocentePeer::DATABASE_NAME);
		}
		...
		if ($this->collActividadsRelatedByVocal2 === null) {
			if ($this->isNew()) {
				...
				$this->collActividadsRelatedByVocal2 = ActividadPeer::doSelectJoinCarrera($criteria, $con, $join_behavior);
			}
		} else {
	...
	public function getActividadsRelatedByVocal2JoinLlamados($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(DocentePeer::DATABASE_NAME);
		}
		...
		if ($this->collActividadsRelatedByVocal2 === null) {
			if ($this->isNew()) {
				...
				$this->collActividadsRelatedByVocal2 = ActividadPeer::doSelectJoinLlamados($criteria, $con, $join_behavior);
			}
		} else {
	...
	{
		if ($deep) {
			if ($this->collActividadsRelatedByPresidente) {
				foreach ((array) $this->collActividadsRelatedByPresidente as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collActividadsRelatedByVocal1) {
				foreach ((array) $this->collActividadsRelatedByVocal1 as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collActividadsRelatedByVocal2) {
				foreach ((array) $this->collActividadsRelatedByVocal2 as $o) {
					$o->clearAllReferences($deep);
				}
			}
