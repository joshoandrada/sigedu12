...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/home/idukaye1/public_html/autog/log/principal_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/home/idukaye1/public_html/autog/cache/principal/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/home/idukaye1/public_html/autog/apps/principal/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  $class = sfConfig::get('sf_factory_user', 'albaUser');
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/idukaye1/public_html/autog/cache/principal/dev/template',
  'lifetime' => 86400,
  'prefix' => '/home/idukaye1/public_html/autog/apps/principal/template',
)));
