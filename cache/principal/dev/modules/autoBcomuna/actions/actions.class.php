 ...
 * @subpackage autoBcomuna
 * @author     ##AUTHOR_NAME##
 * @version    SVN: $Id: actions.class.php 16948 2009-04-03 15:52:30Z fabien $
 */
class autoBcomunaActions extends sfActions
{
  public function executeIndex($request)
  {
    return $this->forward('bcomuna', 'list');
  }
  ...
  public function executeList($request)
  {
    ...
    // pager
    $this->pager = new sfPropelPager('Comun', 12);
    $c = new Criteria();
  ...
  {
    return $this->forward('bcomuna', 'edit');
  }
  ...
  public function executeDeleteSelected($request)
  {
    ...
    return $this->redirect('bcomuna/list');
  }
  ...
  public function executeEdit($request)
  {
    ...
    if ($request->isMethod('post'))
    {
      ...
      {
        return $this->redirect('bcomuna/create');
      }
      ...
      {
        return $this->redirect('bcomuna/edit?id='.$this->comun->getId());
      }
    }
    else
    {
