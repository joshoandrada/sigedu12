...
/**
 * autoDetallecur actions.
 *
 * @package    ##PROJECT_NAME##
 * @subpackage autoDetallecur
 * @author     ##AUTHOR_NAME##
 * @version    SVN: $Id: actions.class.php 16948 2009-04-03 15:52:30Z fabien $
 */
class autoDetallecurActions extends sfActions
{
  ...
  protected function addFiltersCriteria($c)
  {
    ...
    {
      $criterion = $c->getNewCriterion(DetallecursadaPeer::FILTRO_FK_ALUMNO_ID, '');
      $criterion->addOr($c->getNewCriterion(DetallecursadaPeer::FILTRO_FK_ALUMNO_ID, null, Criteria::ISNULL));
      $c->add($criterion);
    }
    else if (isset($this->filters['filtro_fk_alumno_id']) && $this->filters['filtro_fk_alumno_id'] !== '')
    {
      $c->add(DetallecursadaPeer::FILTRO_FK_ALUMNO_ID, $this->filters['filtro_fk_alumno_id']);
    }
