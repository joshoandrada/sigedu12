...
<?php echo form_tag('detallecur/list', array('method' => 'get')) ?>
  ...
  <fieldset>
    ...
    <?php echo get_partial('filtro_fk_alumno_id', array('type' => 'filter', 'filters' => $filters)) ?>
        ...
        <div class="form-row">
    <label for="filters_fecha"><?php echo __('Fecha:') ?></label>
    <div class="content">
  ...
  <ul class="sf_admin_actions">
    <li><?php echo button_to(__('reset'), 'detallecur/list?filter=filter', 'class=sf_admin_action_reset_filter') ?></li>
