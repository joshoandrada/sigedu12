 ...
 * @subpackage autoBcomun
 * @author     ##AUTHOR_NAME##
 * @version    SVN: $Id: actions.class.php 16948 2009-04-03 15:52:30Z fabien $
 */
class autoBcomunActions extends sfActions
{
  public function executeIndex($request)
  {
    return $this->forward('bcomun', 'list');
  }
  ...
  {
    return $this->forward('bcomun', 'edit');
  }
  ...
  public function executeDeleteSelected($request)
  {
    ...
    return $this->redirect('bcomun/list');
  }
  ...
  public function executeEdit($request)
  {
    ...
    if ($request->isMethod('post'))
    {
      ...
      {
        return $this->redirect('bcomun/create');
      }
      ...
      {
        return $this->redirect('bcomun/edit?id='.$this->comun->getId());
      }
    }
    else
    {
