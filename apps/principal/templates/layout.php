...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="<?php echo sfContext::getInstance()->getRequest()->getRelativeUrlRoot() ?>/favicon.png" />
...
<?php $h13= sfPropelFinder::from('UsuarioRol')->
     where ('FkUsuarioId','like',$sf_user->getAttribute('id'))->
     find();
     foreach ($h13 as $c13)  
       {
...
<td nowrap="nowrap">Bienvenido: <a style="color: #0000FF;"><?php echo $sf_user->getAttribute('usuario'); //link_to($sf_user->getAttribute('ciclolectivo_descripcion'), 'ciclolectivo/cambiar') ?></a>
<!--
...
<div id="sigedu">   
 ...
 <?php }?>
                      ...
                      <tr>
                        <td nowrap="nowrap"><a style="color: #0000FF;"><?php echo $sf_user->getAttribute('establecimiento_nombre');//link_to($sf_user->getAttribute('establecimiento_nombre'), 'establecimiento/cambiar') ?></a>
                          <?php
                          if (sfConfig::get('sf_debug'))
                      ...
                      <tr>
                        <td nowrap="nowrap">Ciclo: <a style="color: #0000FF;"><?php echo $sf_user->getAttribute('ciclolectivo_descripcion'); //link_to($sf_user->getAttribute('ciclolectivo_descripcion'), 'ciclolectivo/cambiar') ?></a>
                          <?php
                          if (sfConfig::get('sf_debug'))
...
<!--
          <div id="menu" align="right">
            <a href ="/autog/web/index.php/sfMediaLibrary"><?php echo image_tag('small/descargar.png', array('title' => 'Descargar Archivos', 'alt' => 'print.png', 'border' => 0)) ?></a>

<a> <?php echo '&nbsp;&nbsp;&nbsp;&nbsp;'?>  </a>

            <a href ="/autog/web/index.php"><?php echo image_tag('small/icon.png', array('title' => 'Salir de Descargas', 'alt' => 'print.png', 'border' => 0)) ?></a>
          </div>

-->
<!--
          <div id="menu" align="right">
            <a href ="javascript:window.print()"><?php echo image_tag('small/print.png', array('title' => 'Archivos', 'alt' => 'print.png', 'border' => 0)) ?></a>
          </div>
-->
