 ...
 */
class bintel1Actions extends autobintel1Actions
{
                           ...
                           if ($c==1)         
                            {
                               ...
                               return $this->redirect('bintel1/list?idrendida='.$cur.'&msj='.$mensaje.'&ida='.$nomape);   
                            } 
                            else
                            {
                             if ($c==0)         
                ...
                case 31:
 	               ...
 	               where('FkAlumnoId','like',$alu)->
                       ...
                       foreach ($fww1 as $cs41)
                          ...
                          $actividad1 = $cs41->getFkActividadId();
                          $ord1 = $cs41->getOrden();
                         if ($ord1 == 24 &&  ($idestado1 == 2 || $idestado1 == 9 || $idestado1 == 4|| $idestado1 == 5 || $idestado1 == 8)) 
                            {
                               $c=1;
                            } 
                          }
 ...
 {  
   ...
   $va=sfPropelFinder::from('Detallerendir')->
	where('FkCursadaId','like',$cur)->
		where('FkActividadId','like',$act)->
	delete();
   return $this->redirect('bintel1/list?idrendida='.$cur.'&ida='.$nom);
