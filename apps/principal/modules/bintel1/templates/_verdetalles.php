...
if ($idrendida!=0)
 ...
 <td>
  ...
  <?php echo button_to(__('      Borrar Materia'), 'bintel1/borrarintel?idactividad='.$datos[$e++].'&idrendida='.$sf_params->get('idrendida').'&ida='.$sf_params->get('ida'), array ('confirm' => __('Esta seguro?'),
