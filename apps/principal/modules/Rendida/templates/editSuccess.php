...
<?php include_partial('Rendida/edit_header', array('rendida' => $rendida)) ?>
</div>

<div id="sf_admin_content">
<?php include_partial('Rendida/edit_messages', array('rendida' => $rendida, 'labels' => $labels)) ?>
<?php include_partial('Rendida/edit_form', array('rendida' => $rendida, 'labels' => $labels)) ?>
</div>

<div id="sf_admin_footer">
<?php include_partial('Rendida/edit_footer', array('rendida' => $rendida)) ?>
</div>
