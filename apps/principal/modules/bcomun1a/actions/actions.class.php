 ...
 */
class bcomun1aActions extends autobcomun1aActions
{
       ...
       if ($mat === '' || $mat === null || $mat ===0)
         {
             ...
             switch ($ordenmate) {
                ...
                case 8:
                    ...
                    where('FkActividadId','like',223)->
                     find();
                          ...
                          $mensaje= "Con esta materia elijio su carrera, ".$nommate; 
                          return $this->redirect('Rendida/edit?id='.$cur.'&msj='.$mensaje);   
                          break;
                case 9:
                       $fq=sfPropelFinder::from('Alumno')->
 	               where('Id','like',$alu)->
                ...
                case 11:
                  ...
                  return $this->redirect('bcomun1a/list?idrendida='.$cur.'&msj='.$mensaje);   
         }
         else
         {
 ...
 {  
   ...
   $va=sfPropelFinder::from('Detallerendir')->
	where('FkCursadaId','like',$cur)->
		where('FkActividadId','like',$act)->
	delete();
   return $this->redirect('bcomun1a/list?idrendida='.$cur);
