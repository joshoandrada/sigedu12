...
<?php include_partial('bcomun1a/list_header', array('pager' => $pager)) ?>
<?php include_partial('bcomun1a/list_messages', array('pager' => $pager)) ?>
</div>
...
<?php else: ?>
<?php include_partial('bcomun1a/list', array('pager' => $pager)) ?>
<?php endif; ?>
		...
		$fc = $cc->getFecha();
                if (empty($fc)){
                 $i10[$e10++]=$fc;
                  ...
                  {
                  $i10[$e10++]= date("d-m-Y",strtotime($cc->getFecha()));
                  };
                //$i10[$e10++]=$cc->getFolio();
...
<?php
	...
	$dato8 = $i8; //Envio un array con los Ac.
        ...
        $dato10 = $i10; //Envio un array con los Ac.

	$num= $numero_reg;
?>

<?php include_partial('bcomun1a/verdetalles', array('num' => $num,'dato1' => $dato1, 'dato2' => $dato2, 'dato3' => $dato3, 'datos'=>$datos,'dato4' => $dato4,'dato5' => $dato5,'dato6' => $dato6,'dato7' => $dato7,'dato8' => $dato8,'dato9' => $dato9,'dato10' => $dato10)) ?>
<?php include_partial('list_actions') ?>
</div>


<div id="sf_admin_footer">
<?php include_partial('bcomun1a/list_footer', array('pager' => $pager)) ?>
</div>
