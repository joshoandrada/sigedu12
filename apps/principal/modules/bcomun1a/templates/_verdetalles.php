...
if ($idrendida!=0)
 ...
 <td>
  ...
  <?php echo button_to(__('      Borrar Materia'), 'bcomun1a/borrarcomun1?idactividad='.$datos[$e++].'&idrendida='.$sf_params->get('idrendida'), array ('confirm' => __('Esta seguro?'),
...
<?php echo button_to(__('     Actualizar'), 'drendida/edit?id='.$ides3.'&idrendida='.$sf_params->get('idrendida'), array (
...
<div class="form-row1">
<div class="col2">
<p style="color: #FF0000;"><?php  echo  "Aún no ha cargado materias a rendir"; ?></p>
</div>
</div>
<?php } ?>
