 ...
 */
class bcomunaActions extends autobcomunaActions
{
       ...
       if ($mat === '' || $mat === null || $mat ===0)
         {
             ...
             switch ($ordenmate) {
                case 8:
                    ...
                    where('FkActividadId','like',223)->
                     find();
                          ...
                          return $this->redirect('cursadaa/edit?id='.$cur);   
                          break;
                case 9:
                       $fq=sfPropelFinder::from('Alumno')->
 	               where('Id','like',$alu)->
                ...
                case 11:
                  ...
                  $var1->save();
                  $mensaje= "Materia nueva, ".$nommate; 
                  return $this->redirect('bcomuna/list?idcursada='.$cur.'&idal='.$alu);   
 ...
 {  
   ...
   $can=(int)$this->getRequestParameter('nota');
	...
	$cs->setResult($can);
     ...
     return $this->redirect('bcomuna/list?idcursada='.$cur);
  }
