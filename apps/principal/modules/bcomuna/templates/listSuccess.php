...
<?php include_partial('bcomuna/list_header', array('pager' => $pager)) ?>
<?php include_partial('bcomuna/list_messages', array('pager' => $pager)) ?>
</div>
...
<?php else: ?>
<?php include_partial('bcomuna/list', array('pager' => $pager)) ?>
<?php endif; ?>
...
<?php include_partial('bcomuna/verdetalles', array('num' => $num,'dato1' => $dato1, 'dato2' => $dato2, 'dato3' => $dato3, 'datos'=>$datos,'dato4' => $dato4,'dato5' => $dato5,'dato6' => $dato6,'dato7' => $dato7,'dato8' => $dato8,'dato9' => $dato9)) ?>

<?php include_partial('list_actions') ?>
</div>

<div id="sf_admin_footer">
<?php include_partial('bcomuna/list_footer', array('pager' => $pager)) ?>
</div>
