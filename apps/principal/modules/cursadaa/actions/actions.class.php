...
require('fpdf.php');
class cursadaaActions extends autocursadaaActions
{
...
//             }
    ...
    //return $this->redirect('cursadaa/edit?id='.$cursada->getId());
  }

public function executeAbrir()
  {
   $rend=$this->getRequestParameter('idc');
   $h1= sfPropelFinder::from('Cursada')->
   where ('Id','like',$rend)->
   find();
   foreach ($h1 as $css)  
      {
   ...
   return $this->redirect('cursadaa/edit?id='.$rend);

  }	

public function executeCerrar()
  {
   $rend1=$this->getRequestParameter('idce');
   $h1= sfPropelFinder::from('Cursada')->
     where ('Id','like',$rend1)->
     find();
     foreach ($h1 as $css)  
    ...
    return $this->redirect('cursadaa/edit?id='.$rend1);
  }	
