...
$ides8=$dato9[$e10++];
 ...
 <td>
  ...
  <?php echo button_to(__('      Borrar'), 'bneuroa/borrarneuro?idactividad='.$datos[$e++].'&idcursada='.$sf_params->get('idcursada'), array ('confirm' => __('Esta seguro?'),
  'class' => 'sf_admin_action_delete',));  ?>
  </td>
  <?php // $e--;?>		
<td>

<?php echo button_to(__('     Actualizar'), 'dcursada/edit?id='.$ides3.'&idcursada='.$sf_params->get('idcursada').'&idb=1', array (
