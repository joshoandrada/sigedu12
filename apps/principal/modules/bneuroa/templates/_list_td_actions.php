 ...
 // $d=0; 
  ...
  foreach ($fww as $cs4)
    ...
    <?if ($c==1){ ?>
     ...
     <?}else{?>
       <?if ($a==1 && $b==1){ ?>
          <li><?php echo button_to(('     Agregar'),'bneuroa/agreganeuro?idactividad='.$neuro->getId().'&idcursada='.$sf_params->get('idcursada').'&idal='.$idal1.'&orden='.$neuro->getOrden(), array ('class' => 'sf_admin_action_create',))?></li>
       <?}else{?>
    ...
    foreach ($fww1 as $cs41)
     {
       $idestado1 = $cs41->getFkDcursadaId();   
       $ord1 = $cs41->getOrden();
       if ($ord1 == 3 && ($idestado1 == 2 || $idestado1 == 4 || $idestado1 == 5 || $idestado1 == 8 || $idestado1 == 9 || $idestado1 == 10)) 
          {
            $d=1;
          } 
      }
    ...
    foreach ($fww1 as $cs41)
     {
       ...
       if ($ord1 == 9 && ($idestado1 == 2 || $idestado1 == 4 || $idestado1 == 5 || $idestado1 == 8 || $idestado1 == 9 || $idestado1 == 10)) 
          {
            $d=1;
          } 
    ...
    foreach ($fww1 as $cs41)
     {
       $idestado1 = $cs41->getFkDcursadaId();   
       $ord1 = $cs41->getOrden();
       if ($ord1 == 16 && ($idestado1 == 2 || $idestado1 == 4 || $idestado1 == 5 || $idestado1 == 8 || $idestado1 == 9 || $idestado1 == 10)) 
          {
            $d=1;
          } 
      }
    ...
    foreach ($fww1 as $cs41)
     {
       $idestado1 = $cs41->getFkDcursadaId();   
       $ord1 = $cs41->getOrden();
       if ($ord1 == 2 && ($idestado1 == 2 || $idestado1 == 4 || $idestado1 == 5 || $idestado1 == 8 || $idestado1 == 9 || $idestado1 == 10)) 
          {
            $d=1;
          } 
      }
    ...
    foreach ($fww1 as $cs41)
     {
       $idestado1 = $cs41->getFkDcursadaId();   
       $ord1 = $cs41->getOrden();
       if ($ord1 == 20 && ($idestado1 == 2 || $idestado1 == 4 || $idestado1 == 5 || $idestado1 == 8 || $idestado1 == 9 || $idestado1 == 10)) 
          {
            $d=1;
          } 
      }
    ...
    foreach ($fww1 as $cs41)
     {
       $idestado1 = $cs41->getFkDcursadaId();   
       $ord1 = $cs41->getOrden();
       if ($ord1 == 12 && ($idestado1 == 2 || $idestado1 == 4 || $idestado1 == 5 || $idestado1 == 8 || $idestado1 == 9 || $idestado1 == 10)) 
          {
            $d=1;
          } 
      }
    ...
    foreach ($fww1 as $cs41)
     {
       $idestado1 = $cs41->getFkDcursadaId();   
       $ord1 = $cs41->getOrden();
       if ($ord1 == 14 && ($idestado1 == 2 || $idestado1 == 4 || $idestado1 == 5 || $idestado1 == 8 || $idestado1 == 9 || $idestado1 == 10)) 
          {
            $d=1;
          } 
      }
    ...
    foreach ($fww1 as $cs41)
     {
       $idestado1 = $cs41->getFkDcursadaId();   
       $ord1 = $cs41->getOrden();
       if ($ord1 == 29 && ($idestado1 == 2 || $idestado1 == 4 || $idestado1 == 5 || $idestado1 == 8 || $idestado1 == 9 || $idestado1 == 10)) 
          {
            $d=1;
          } 
       if ($ord1 == 18 && ($idestado1 == 2 || $idestado1 == 4 || $idestado1 == 5 || $idestado1 == 8 || $idestado1 == 9 || $idestado1 == 10)) 
          {
            $e=1;
          } 
       if ($ord1 == 19 && ($idestado1 == 2 || $idestado1 == 4 || $idestado1 == 5 || $idestado1 == 8 || $idestado1 == 9 || $idestado1 == 10)) 
          {
            $f=1;
          } 
       if ($ord1 == 14 && ($idestado1 == 2 || $idestado1 == 4 || $idestado1 == 5 || $idestado1 == 8 || $idestado1 == 9 || $idestado1 == 10)) 
