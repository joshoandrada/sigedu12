...
<h1><?php echo __('Lista de Materias en Neuromotor- Cursada N&#186:'.$idc, 
array()) ?></h1>

<h2><?php echo "Alumno: ".$ape." ".$nom; ?></h2>
<div id="sf_admin_header">
<?php include_partial('bneuroa/list_header', array('pager' => $pager)) ?>
<?php include_partial('bneuroa/list_messages', array('pager' => $pager)) ?>
</div>
...
<?php else: ?>
<?php include_partial('bneuroa/list', array('pager' => $pager)) ?>
<?php endif; ?>
...
<?php include_partial('bneuroa/verdetalles', array('num' => $num,'dato1' => $dato1, 'dato2' => $dato2, 'dato3' => $dato3, 'datos'=>$datos,'dato4' => $dato4,'dato5' => $dato5,'dato6' => $dato6,'dato7' => $dato7,'dato8' => $dato8,'dato9' => $dato9)) ?>
...
<?php include_partial('bneuroa/list_footer', array('pager' => $pager)) ?>
</div>
