...
<div class="form-row">
    <?php include_partial('cursada/verdetalles', array('num' => $num,'dato1' => $dato1, 'datos'=>$datos,'dato2' => $dato2,'dato3' => $dato3,'dato4' => $dato4,'dato5' => $dato5,'dato6' => $dato6,'dato7' => $dato7,'idcursada'=>$cursada->getId(),'plan'=>$canio)) ?>
</div>
</fieldset>
...
<div class="form-row1">
<div class="col2">
<p style="color: #FF0000;"><?php  echo  "Aún no ha enviado Cursada..."; ?></p>
</div>
</div>
...
<ul class="sf_admin_actions">
      <li><?php echo button_to(('Cargar Materias'), 'bcomun/list?idcursada='.$cursada->getId().'&idal='.$alu, array ( 
...
<? if($alucarre === 10){?>
<ul class="sf_admin_actions">
      <li><?php echo button_to(('Cargar Materias'), 'bneuro/list?idcursada='.$cursada->getId().'&idal='.$alu, array ( 
  'class' => 'sf_admin_action_cuenta1',
))?></li>
    </ul>
<?}?>
...
<? if($alucarre === 11){?>
<ul class="sf_admin_actions">
      <li><?php echo button_to(('Cargar Materias'), 'bauditiva/list?idcursada='.$cursada->getId().'&idal='.$alu, array ( 
  'class' => 'sf_admin_action_cuenta1',
))?></li>
    </ul>
<?}?>
...
<? if($alucarre === 12){?>
<ul class="sf_admin_actions">
      <li><?php echo button_to(('Cargar Materias'), 'bintel/list?idcursada='.$cursada->getId().'&idal='.$alu, array ( 
  'class' => 'sf_admin_action_cuenta1',
))?></li>
    </ul>
<?}?>
...
<? if($alucarre === 13){?>
<ul class="sf_admin_actions">
      <li><?php echo button_to(('Cargar Materias'), 'bvisual/list?idcursada='.$cursada->getId().'&idal='.$alu, array ( 
  'class' => 'sf_admin_action_cuenta1',
))?></li>
    </ul>
<?}?>
