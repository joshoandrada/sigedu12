...
<li>
<?php echo button_to(('     Agregar'),'bauditiva1a/agregaauditiva1?idactividad='.$auditiva->getId().'&idrendida='.$sf_params->get('idrendida').'&orden='.$auditiva->getOrden(), array ('class' => 'sf_admin_action_create',))?>
</li>
...
<li>
<?php echo button_to(('     Examen Final'),'bauditiva1a/agregaauditiva1?idactividad='.$auditiva->getId().'&idrendida='.$sf_params->get('idrendida').'&orden='.$auditiva->getOrden().'&ida='.$ida, array ('class' => 'sf_admin_action_create',))?>
</li>
...
<li>
<?php echo button_to(('     Libre'),'bauditiva1a/agregaauditiva1?idactividad='.$auditiva->getId().'&idrendida='.$sf_params->get('idrendida').'&orden='.$auditiva->getOrden().'&ida='.$ida, array ('class' => 'sf_admin_action_create',))?>
</li>
