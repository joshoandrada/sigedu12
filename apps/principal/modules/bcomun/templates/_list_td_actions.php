...
<?php echo button_to(('     Agregar'),'bcomun/agregacomun?idactividad='.$comun->getId().'&idcursada='.$sf_params->get('idcursada').'&orden='.$comun->getOrden(), array ('class' => 'sf_admin_action_create',))?>
</li>
</ul>
</td>
-->
...
<? if ($idact == 8 || $idact == 9 || $idact == 10 || $idact == 11){?>
   ...
   <li><?php echo button_to(('     Agregar'),'bcomun/agregacomun?idactividad='.$comun->getId().'&idcursada='.$sf_params->get('idcursada').'&orden='.$comun->getOrden().'&idal='.$idal1, array ('class' => 'sf_admin_action_create',))?></li>
<?}?>
