 ...
 */
class bvisual1Actions extends autobvisual1Actions
{
                           ...
                           if ($c==1)         
                            {
                               ...
                               return $this->redirect('bvisual1/list?idrendida='.$cur.'&msj='.$mensaje.'&ida='.$nomape);   
                            } 
                            else
                            {
                             if ($c==0)         
 ...
 {  
   ...
   $va=sfPropelFinder::from('Detallerendir')->
	where('FkCursadaId','like',$cur)->
		where('FkActividadId','like',$act)->
	delete();
   return $this->redirect('bvisual1/list?idrendida='.$cur.'&ida='.$nom);
