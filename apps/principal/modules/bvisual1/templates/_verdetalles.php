...
if ($idrendida!=0)
 ...
 <td>
  ...
  <?php echo button_to(__('      Borrar Materia'), 'bvisual1/borrarvisual1?idactividad='.$datos[$e++].'&idrendida='.$sf_params->get('idrendida').'&ida='.$sf_params->get('ida'), array ('confirm' => __('Esta seguro?'),
