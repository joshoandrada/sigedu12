...
<h1><?php echo __('Lista de Materias para Rendir de Ciegos', array()) ?></h1>
<h2><?php echo "Alumno: ".$nombre.' '.$ape; ?></h2>

<?}else{?>

<h1><?php echo __('Lista de Materias para Rendir de Ciegos - Rendida N&#186:'.$idc, 
array()) ?></h1>
...
<?php include_partial('bvisual1/list_header', array('pager' => $pager)) ?>
<?php include_partial('bvisual1/list_messages', array('pager' => $pager)) ?>
</div>
...
<?php else: ?>
<?php include_partial('bvisual1/list', array('pager' => $pager)) ?>
<?php endif; ?>
...
<?php include_partial('bvisual1/verdetalles', array('num' => $num,'dato1' => $dato1, 'dato2' => $dato2, 'dato3' => $dato3, 'datos'=>$datos,'dato4' => $dato4,'dato5' => $dato5,'dato6' => $dato6,'dato7' => $dato7,'dato8' => $dato8)) ?>
...
<?php include_partial('bvisual1/list_footer', array('pager' => $pager)) ?>
</div>
