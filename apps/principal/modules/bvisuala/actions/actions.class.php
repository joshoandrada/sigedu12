 ...
 */
class bvisualaActions extends autobvisualaActions
{
                           ...
                           if ($a==1 && $b==1)         
                            {
                               ...
                               return $this->redirect('bvisuala/list?idcursada='.$cur.'&idal='.$aaa);   
                            } 
                            break;
                case 11:
                       $a=0;
  ...
  find();
   ...
   $va=sfPropelFinder::from('Detallecursada')->
	where('FkCursadaId','like',$cur)->
		where('FkActividadId','like',$act)->
	delete();
   return $this->redirect('bvisuala/list?idcursada='.$cur.'&idal='.$alu);
