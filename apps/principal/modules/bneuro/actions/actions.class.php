 ...
 */
class bneuroActions extends autobneuroActions
{
                           ...
                           if ($a==1 && $b==1)         
                            {
                               ...
                               return $this->redirect('bneuro/list?idcursada='.$cur.'&msj='.$mensaje.'&idal='.$aaa);   
                            } 
                            else
                            {
                             if ($a==0)         
...
public function executeBorrarneuro()
 {  
  ...
  where('FkCursadaId','like',$cur)->
    where('FkActividadId','like',$act)->
  delete();
   return $this->redirect('bneuro/list?idcursada='.$cur.'&idal='.$alu);
 ...
 {  
  ...
  $cs->setResult($can);
     ...
     return $this->redirect('bneuro/list?idcursada='.$cur.'&idal='.$iii);
}
