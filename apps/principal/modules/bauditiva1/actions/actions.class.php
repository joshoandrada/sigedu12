 ...
 *
 * @package    alba
 * @subpackage bauditiva1
 * @author     Your name here
 * @version    SVN: $Id: actions.class.php 5125 2007-09-16 00:53:55Z dwhittle $
 */
class bauditiva1Actions extends autobauditiva1Actions
{
                           ...
                           if ($c==1)         
                            {
                               ...
                               return $this->redirect('bauditiva1/list?idrendida='.$cur.'&msj='.$mensaje.'&ida='.$nomape);   
                            } 
                            else
                            {
                             if ($c==0)         
 ...
 {  
   ...
   $va=sfPropelFinder::from('Detallerendir')->
	where('FkCursadaId','like',$cur)->
		where('FkActividadId','like',$act)->
	delete();
   return $this->redirect('bauditiva1/list?idrendida='.$cur.'&ida='.$nom);
