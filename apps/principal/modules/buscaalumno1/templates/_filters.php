...
<?php echo form_tag('buscaalumno1/list', array('method' => 'get')) ?>
  ...
  <ul class="sf_admin_actions">
    <li><?php echo button_to(__('reset'), 'buscaalumno1/list?filter=filter', 'class=sf_admin_action_reset_filter') ?></li>
