 ...
 *
 * @package    alba
 * @subpackage bauditiva
 * @author     Your name here
 * @version    SVN: $Id: actions.class.php 5125 2007-09-16 00:53:55Z dwhittle $
 */
class bauditivaActions extends autobauditivaActions
{
                           ...
                           if ($a==1 && $b==1)         
                            {
                               ...
                               return $this->redirect('bauditiva/list?idcursada='.$cur.'&msj='.$mensaje);   
                            } 
                            else
                            {
                             if ($a==0)         
...
public function executeBorrarauditiva()
 {  
  ...
  where('FkCursadaId','like',$cur)->
    where('FkActividadId','like',$act)->
  delete();
   return $this->redirect('bauditiva/list?idcursada='.$cur);
