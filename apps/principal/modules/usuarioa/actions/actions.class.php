...
class usuarioaActions extends autousuarioaActions
{
    ...
    function executeSavePermiso($request) {
        ...
        return $this->redirect('usuarioa/editPermiso?id='.$usuarioId);
    }
  ...
  public function executeSaveRol(sfWebRequest $request)
  {
    ...
    return $this->redirect('usuarioa/editPermiso?id=' . $this->usuario->getId());
  }
 ...
 protected function guardarAlu($usuario)
  {
