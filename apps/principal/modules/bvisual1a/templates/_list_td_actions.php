...
<li><?php echo button_to(('     Agregar'),'bvisual1a/agregavisual1?idactividad='.$visual->getId().'&idrendida='.$sf_params->get('idrendida').'&orden='.$visual->getOrden(), array ('class' => 'sf_admin_action_create',))?>
</li>
</ul>
</td>
-->
...
<? if ($promo == 1){?>
  ...
  <? if ($regular == 2 || $regular == 10){?>
           ...
           <? if ($regular == 10){?>  
              ...
              <?}?>
       <?}else{?>
          <li><?php echo button_to(('     Examen Final'),'bvisual1a/agregavisual1?idactividad='.$visual->getId().'&idrendida='.$sf_params->get('idrendida').'&orden='.$visual->getOrden().'&ida='.$ida, array ('class' => 'sf_admin_action_create',))?>
          </li>
    <?}?>
    <?}else{?>
       <? if ($promo == 0){?>
          <li><?php echo button_to(('     Libre'),'bvisual1a/agregavisual1?idactividad='.$visual->getId().'&idrendida='.$sf_params->get('idrendida').'&orden='.$visual->getOrden().'&ida='.$ida, array ('class' => 'sf_admin_action_create',))?>
          </li>
       <?}?>
