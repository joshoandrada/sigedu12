...
if ($idrendida!=0)
 ...
 <td>
  ...
  <?php echo button_to(__('      Borrar Materia'), 'bvisual1a/borrarvisual1?idactividad='.$datos[$e++].'&idrendida='.$sf_params->get('idrendida').'&ida='.$sf_params->get('ida'), array ('confirm' => __('Esta seguro?'),
...
<td>
<?php $c=13;?>
<?php echo button_to(__('     Actualizar'), 'drendida/edit?id='.$ides3.'&idrendida='.$sf_params->get('idrendida').'&idcarre='.$c.'&ida='.$sf_params->get('ida'), array (
