...
<h1><?php echo __('Lista de Materias para Rendir de Visual - Rendida N&#186:'.$idc, 
array()) ?></h1>
<h2><?php echo "Alumno: ".$ida ?></h2>

<div id="sf_admin_header">
<?php include_partial('bvisual1a/list_header', array('pager' => $pager)) ?>
<?php include_partial('bvisual1a/list_messages', array('pager' => $pager)) ?>
</div>
...
<?php else: ?>
<?php include_partial('bvisual1a/list', array('pager' => $pager)) ?>
<?php endif; ?>
...
<?php include_partial('bvisual1a/verdetalles', array('num' => $num,'dato1' => $dato1, 'dato2' => $dato2, 'dato3' => $dato3, 'datos'=>$datos,'dato4' => $dato4,'dato5' => $dato5,'dato6' => $dato6,'dato7' => $dato7,'dato8' => $dato8,'dato9' => $dato9)) ?>
...
<?php include_partial('bvisual1a/list_footer', array('pager' => $pager)) ?>
</div>
