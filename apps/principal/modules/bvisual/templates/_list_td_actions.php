...
<li><?php echo button_to(('     Agregar'),'bvisual/agregavisual?idactividad='.$visual->getId().'&idcursada='.$sf_params->get('idcursada').'&orden='.$visual->getOrden(), array ('class' => 'sf_admin_action_create',))?>
</li>
</ul>
</td>
-->
 ...
 // $d=0; 
  ...
  foreach ($fww as $cs4)
    ...
    <?if ($c==1){ ?>
     ...
     <?}else{?>
       <?if ($a==1 && $b==1){ ?>
         <li><?php echo button_to(('     Agregar'),'bvisual/agregavisual?idactividad='.$visual->getId().'&idcursada='.$sf_params->get('idcursada').'&orden='.$visual->getOrden().'&idal='.$idal1, array ('class' => 'sf_admin_action_create',))?>
         </li>
       <?}else{?>
  ...
  foreach ($fww as $cs4)
    {
      ...
      if ($ord == $idact && ($idestado == 4 || $idestado == 8 || $idestado == 5 || $idestado == 6)) 
        {
          $esta = $cs4->getEstado();
          $c=1;
         }
  ...
  foreach ($fww as $cs4)
    {
      ...
      if ($ord == 22 && ($idestado == 4 || $idestado == 5 || $idestado == 8)) 
       ...
       if ($ord == 12 && ($idestado == 4 || $idestado == 5 || $idestado == 8 || $idestado == 6)) 
        {
          $d=1;
         }   
    }
