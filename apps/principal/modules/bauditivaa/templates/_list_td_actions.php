...
<?php echo button_to(('     Agregar'),'bauditivaa/agregaauditiva?idactividad='.$auditiva->getId().'&idcursada='.$sf_params->get('idcursada').'&orden='.$auditiva->getOrden(), array ('class' => 'sf_admin_action_create',))?>
</li>
</ul>
</td>
-->
  ...
  foreach ($fww as $cs4)
    ...
    <?if ($c==1){ ?>
     ...
     <?}else{?>
       <?if ($a==1 && $b==1){ ?>
<li>  
<?php echo button_to(('     Agregar'),'bauditivaa/agregaauditiva?idactividad='.$auditiva->getId().'&idcursada='.$sf_params->get('idcursada').'&orden='.$auditiva->getOrden().'&idal='.$idal1, array ('class' => 'sf_admin_action_create',))?>
</li>
       <?}else{?>
  ...
  foreach ($fww as $cs4)
   ...
   <?}else{?> 
      <?if ($a==1 && $b==1 && $d==1 && $e==1 && $f==1 && $g==1 && $h==1){ ?>
        <li>  
<?php echo button_to(('     Agregar'),'bauditivaaa/agregaauditiva?idactividad='.$auditiva->getId().'&idcursada='.$sf_params->get('idcursada').'&orden='.$auditiva->getOrden().'&idal='.$idal1, array ('class' => 'sf_admin_action_create',))?>
</li>
      <?}else{?>
