    ...
    <?php echo form_tag('alumno/edit', 'id=sf_admin_edit_form name=sf_admin_edit_form multipart=true') ?>
      ...
      Edad: <input type="text" value="<?php echo (isset($edad)?$edad:"")?>" disabled="true" size="4">
        ...
        <fieldset id="sf_fieldset_donde_vive" class="">
            ...
            <div class="form-row">
              <?php echo label_for('alumno[telefono]', __('Tel&eacute;fono Personal:'), '') ?>
            ...
            <div class="form-row">
              <?php echo label_for('alumno[telefono_fijo]', __('Tel&eacute;fono Fijo:'), '') ?>
              <div class="content<?php if ($sf_request->hasError('alumno{telefono_fijo}')): ?> form-error<?php endif; ?>">
              <?php if ($sf_request->hasError('alumno{telefono_fijo}')): ?>
                <?php echo form_error('alumno{telefono_fijo}', array('class' => 'form-error-msg')) ?>
              <?php endif; ?>

              <?php echo object_input_tag($alumno, 'getTelefonoFijo', array (
              'size' => 20,
              'control_name' => 'alumno[telefono_fijo]',
            )) ?>
                </div>
            </div>
        </fieldset>
        ...
        <div class="form-row">
       -->
         <?php //echo label_for('alumno[fk_cuenta_id]', __(''), '') ?>
               <?php $alumno->setFkCuentaId('1');?>
