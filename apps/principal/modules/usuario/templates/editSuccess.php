...
<?php if ($usuario->getFkAlumno()==0 ||$usuario->getFkAlumno()=="") {?>

<div class="form-row">
  <?php echo label_for('usuaio[nro_documento]', __($labels['usuario{nro_documento}']), '') ?>
  <div class="content<?php if ($sf_request->hasError('usuario{nro_documento}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('usuario{nro_documento}')): ?>
    <?php echo form_error('usuario{nro_documento}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

  <?php $value = object_input_tag($usuario, 'getNroDocumento', array (
  'size' => 16,
  'control_name' => 'usuario[nro_documento]',
)); echo $value ? $value : '&nbsp;' ?>
    </div>
</div>
<?php } else {?>
<div class="form-row">
  <?php echo "Dni :"."&nbsp;"."&nbsp;"."&nbsp;"."&nbsp;"."&nbsp;"."&nbsp;"."&nbsp;"."&nbsp;"."&nbsp;"."&nbsp;"."&nbsp;"."&nbsp;"."&nbsp;"."&nbsp;"."&nbsp;"."&nbsp;"."&nbsp;"."&nbsp;"."&nbsp;"."&nbsp;"."&nbsp;"."&nbsp;"."&nbsp;"."&nbsp;"."&nbsp;"."&nbsp;".$usuario->getNroDocumento() ?>
</div>
<?php }?>
...
<?php echo input_hidden_tag('usuario[fk_establecimiento_id]',$aaaa);?>
