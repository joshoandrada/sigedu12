...
?>
<h1><?php echo __('Lista de Materias en Discapacidad Intectual- Cursada N&#186:'.$idc, 
array()) ?></h1>
<h2><?php echo "Alumno: ".$ape." ".$nom; ?></h2>
<div id="sf_admin_header">
<?php include_partial('bintela/list_header', array('pager' => $pager)) ?>
<?php include_partial('bintela/list_messages', array('pager' => $pager)) ?>
</div>
...
<?php else: ?>
<?php include_partial('bintela/list', array('pager' => $pager)) ?>
<?php endif; ?>
...
<?php include_partial('bintela/verdetalles', array('num' => $num,'dato1' => $dato1, 'dato2' => $dato2, 'dato3' => $dato3, 'datos'=>$datos,'dato4' => $dato4,'dato5' => $dato5,'dato6' => $dato6,'dato7' => $dato7)) ?>
<?php include_partial('list_actions') ?>
</div>


<div id="sf_admin_footer">
<?php include_partial('bintela/list_footer', array('pager' => $pager)) ?>
</div>
