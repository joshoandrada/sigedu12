...
<li>
<?php echo button_to(('     Agregar'),'bintela/agregaintel?idactividad='.$intelectual->getId().'&idcursada='.$sf_params->get('idcursada').'&idal='.$idal1.'&orden='.$intelectual->getOrden(), array ('class' => 'sf_admin_action_create',))?>
</li>
</ul>
</td>
-->
  ...
  foreach ($fww as $cs4)
    {
      ...
      if ($ord == $idact && ($idestado == 1 || $idestado == 8)) 
        {
          $esta = $cs4->getEstado();
          $c=1;
         }
