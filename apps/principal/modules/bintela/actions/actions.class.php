 ...
 */
class bintelaActions extends autobintelaActions
{
                           ...
                           if ($a==1 && $b==1)         
                            {
                               ...
                               return $this->redirect('bintela/list?idcursada='.$cur.'&msj='.$mensaje.'&idal='.$aaa);   
                            } 
                            break;
                case 11:
                       $a=0;
 ...
 {  
   ...
   $va=sfPropelFinder::from('Detallecursada')->
	  where('FkCursadaId','like',$cur)->
		where('FkActividadId','like',$act)->
	  delete();
    return $this->redirect('bintela/list?idcursada='.$cur.'&idal='.$alu);
 ...
 {  
   ...
   $can=(int)$this->getRequestParameter('nota');
	...
	$cs->setResult($can);
     ...
     return $this->redirect('bintela/list?idcursada='.$cur);
}
